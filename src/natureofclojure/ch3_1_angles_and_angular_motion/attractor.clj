...
;;
;; Specifically:
;; https://github.com/shiffman/The-Nature-of-Code-Examples/blob/master/Processing/chp3_oscillation/NOC_3_02_forces_angular_motion/Attractor.pde
;;
(ns natureofclojure.ch3-1-angles-and-angular-motion.attractor
