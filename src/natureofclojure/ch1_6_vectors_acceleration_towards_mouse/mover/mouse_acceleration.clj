...
;;
;; Specifically:
;; https://github.com/shiffman/The-Nature-of-Code-Examples/blob/master/Processing/chp1_vectors/NOC_1_10_motion101_acceleration/Mover.pde
;;
(ns natureofclojure.ch1-6-vectors-acceleration-towards-mouse.mover.mouse-acceleration
...
(defn update-mover [m]
  (let [mouse [(qc/mouse-x) (qc/mouse-y)]
        ...
        acc (mv/normalize acc)
        acc (mv/multiply 0.2 acc)]
